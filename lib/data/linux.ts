  ...
  questions: [
    ...
    },
    {
      ...
      answers: [
        ...
        { id: '1', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/opt']] },
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/sys/fs/ext4']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/mnt']] },
      ],
      correctAnswer: '0',
    },
    {
      ...
      answers: [
        ...
        { id: '1', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/apt/auth.conf.d']] },
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/resolv.conf']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/sys/kernel/profiling']] },
      ],
      correctAnswer: '0',
    },
    {
      ...
      answers: [
        ...
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/resolv.conf']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/sys/kernel/address_bits']] },
      ],
      correctAnswer: '0',
    },
    {
      ...
      answers: [
        ...
        { id: '1', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/group-']] },
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/hosts']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/crontab']] },
      ],
      correctAnswer: '0',
    },
    {
    ...
    },
    {
      ...
      answers: [
        ...
        { id: '1', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/cron.hourly/.placeholder']] },
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/cron.d/.anacron']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/cron.daily/apache2']] },
      ],
      correctAnswer: '0',
    },
    {
      ...
      answers: [
        ...
        { id: '1', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/hosts']] },
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/etc/nginx/nginx.conf']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/opt/file']] },
      ],
      correctAnswer: '0',
    },
    {
    ...
    {
      question: [
        [QuizMarkdownType.TEXT, 'You need to run the command'],
        [QuizMarkdownType.INLINE_CODE, 'netstat -tlnp'],
        [QuizMarkdownType.TEXT, 'from a Docker container shell, but the Docker container does not have it installed.'],
        [QuizMarkdownType.TEXT, 'Which command can be used to install it?'],
      ],
      answers: [
        { id: '0', answer: [[QuizMarkdownType.INLINE_CODE, 'apt-get install -y net-tools']] },
        { id: '1', answer: [[QuizMarkdownType.INLINE_CODE, 'apt-get install -y iproute2']] },
        { id: '2', answer: [[QuizMarkdownType.INLINE_CODE, '/bin']] },
        { id: '3', answer: [[QuizMarkdownType.INLINE_CODE, '/opt/coolprogram']] },
      ],
      correctAnswer: '0',
    },
    {
      question: [
        [QuizMarkdownType.TEXT, 'You need to run the command'],
        [QuizMarkdownType.INLINE_CODE, 'ss -tulwn'],
        [QuizMarkdownType.TEXT, 'from a Docker container shell, but the Docker container does not have it installed.'],
        [QuizMarkdownType.TEXT, 'Which command can be used to install it?'],
      ],
      answers: [
