...
{ purpleField: 1 }`],
  ...
  _id: DB_NAME + ".thecollection"
    ...
    {
      question: [
        [QuizMarkdownType.TEXT, 'Index creation MUST precede the insertion of records for indexes to be created for those records.'],
      ],
      answers: [
        {
          id: '0',
    ...
    {
      question: [
        [QuizMarkdownType.TEXT, 'A collection can be dropped in a distributed transaction.'],
      ],
      answers: [
        {
          id: '0',
    ...
    {
      question: [
        [QuizMarkdownType.TEXT, 'A high number of indexes can increase read times.'],
      ],
      answers: [
        {
          id: '0',
